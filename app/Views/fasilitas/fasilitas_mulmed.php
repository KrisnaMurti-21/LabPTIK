...
<!--Page Title-->
<section class="page-title" style="background-image: url(<?= base_url()?>/assets/images/obi-pixel6propix-uUNtBBG9pcY-unsplash.jpg );">
...
<div class="container p-5">
    <div class="row">
        ...
        <div class="col-sm-8">
            <p>Fasilitas pada Laboratorium Multimedia di fasilitasi dengan failitas yang dapat mendukung
                kegiatan mahasiswa ataupun dosen untuk melakukan perancangan desain dan pengembangan media pembelajaran. </p>
        </div>
    </div>
</div>
